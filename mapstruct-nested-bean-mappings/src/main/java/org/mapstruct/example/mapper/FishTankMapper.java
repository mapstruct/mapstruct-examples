...
public interface FishTankMapper {
    ...
    FishTankMapper INSTANCE = Mappers.getMapper( FishTankMapper.class );
     ...
     @Mapping(target = "quality.report.organisation.approval", source = "approvalParam")
    FishTankDto map(FishTank source, String approvalParam);
    ...
    FishTank map(FishTankDto source, String approvalParam);
